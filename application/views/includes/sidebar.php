            ...
            <?php } else if ($this->session->userdata('user_details')[0]['user_type'] == 'Affiliate') { ?>
                ...
                <ul id="sidebarnav">
                    <li class="<?php if (!empty($pagename)) {
                        ...
                        <li> <a class="waves-effect" href="<?= base_url("scaleo") ?>" aria-expanded="false"><i class="fas fa-chart-bar" style="color: #fff;"></i><span class="hide-menu">Scaleo Campaigns</span></a></li>
