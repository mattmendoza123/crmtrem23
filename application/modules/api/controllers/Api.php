...
class Api extends MY_Controller
{
	...
	public function reports(){
		...
		$transaction_data = [];
		$data_headers = [];
		$url = 'https://tremendio.scaletrk.com/api/v2/network/reports/conversions?api-key=50b3610e8131bed482340559725750ac13682d0d&lang=en&sortField=added_timestamp&sortDirection=desc&perPage='.$perPage.'&page='.$page.'&rangeFrom='.$start_date.'&rangeTo='.$end_date.'&columns=sub_id1,sub_id2,sub_id3,revenue,added_timestamp,changed_timestamp,currency,transaction_id,advertiser,affiliate&filters=advertisers:500,affiliates:1602'; // URL of the API you want to request	
