...
<section id="wrapper">
    <div class="login-register">
        <div class="login-box card">
            <div class="card-body">
                <form class="form-horizontal form-material" id="sendotp" method="post" action="<?= base_url("sendotp/otp_verify"); ?>">
        ...
        <div class="modal-dialog">
            <div class="modal-content" id="sendotpmodal">
                ...
                <div class="modal-body">
                    <form class="form_sendotp" action="<?php echo base_url('sendotp/otp'); ?>" method="post">
                        <div class="form-body">
