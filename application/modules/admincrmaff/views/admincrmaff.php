    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content" id="addusermodal">
                <div class="modal-header">
                    ...
                    <form class="form-horizontal form-material" method="post" enctype="multipart/form-data" id="adduser"  action="<?= base_url("admincrmaff/adduser"); ?>">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content" id="updateusermodal">
                <div class="modal-header">
                    ...
                    <div class="modal-body">
                    <form  method="post" enctype="multipart/form-data" action="<?= base_url("admincrmaff/updatecrmaff"); ?>" id="updatecrmaff">
