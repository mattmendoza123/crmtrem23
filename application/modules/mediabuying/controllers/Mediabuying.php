...
class Mediabuying extends MY_Controller
{
	...
	if($start_date!="" && $end_date!=""){		
		$url = 'https://tremendio.scaletrk.com/api/v2/network/reports/conversions?api-key=50b3610e8131bed482340559725750ac13682d0d&lang=en&sortField=added_timestamp&sortDirection=desc&perPage=300&page=1&rangeFrom='.$start_date.'&rangeTo='.$end_date.'&columns=transaction_id,added_timestamp,payout,sub_id1,offer,affiliate,link&filters[affiliates]=1247'; // URL of the API you want to request
	} else {
		$url = 'https://tremendio.scaletrk.com/api/v2/network/reports/conversions?api-key=50b3610e8131bed482340559725750ac13682d0d&lang=en&sortField=added_timestamp&sortDirection=desc&perPage=300&page=1&rangeFrom=2024-03-01&rangeTo=2024-12-31&columns=transaction_id,added_timestamp,payout,sub_id1,offer,affiliate,link&filters[affiliates]=1247'; // URL of the API you want to request
	}
