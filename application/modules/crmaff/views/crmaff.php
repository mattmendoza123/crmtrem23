    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-themecolor page-title-text">CRM Affiliate</h3>
            </div>
            <div class="col-md-7 align-self-center text-right">
            <!-- <button type="button" id="excsv"><i class="fa fa-plus-circle"></i> Export to CSV </button> -->
            <?php if ($this->session->userdata('user_details')[0]['user_type'] == 'Affiliate') { ?>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="crmaff_datatable" class="table table-striped jambo_table bulk_action dt-responsive" style="width: 100% !important;">
                                <thead>
                                    <tr>
                                        <th>Company</th>
                                        <th>First Name</th>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content" id="addusermodal">
                <div class="modal-header">
                    <h4 class="modal-title" id="AddUserModalTitle"><img src="https://crm.tremendio.network/assets/css/icons/new-icons/001-add-users.png" style="width: 20%;">&nbsp;&nbsp;Add User </img></h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
                </div>            
                    <div class="modal-body">
                    <form class="form-horizontal form-material" method="post" enctype="multipart/form-data" id="adduser"  action="<?= base_url("crmaff/adduser"); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <br>
                                    <select id="aff_tags[]" class="form-control" name="aff_tags[]" multiple multiselect-search="true">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <br>
                                    <select id="aff_model[]" class="form-control" name="aff_model[]" multiple multiselect-search="true">
                                    <option>&nbsp;CPC</option>
                                    <option>&nbsp;CPM</option>
                                    <option>&nbsp;CPA</option>
                                    <option>&nbsp;CPL</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                 <label for="aff_traffic_source">Traffic Source</label>
                                    <br>
                                    <select id="aff_traffic_source[]" class="form-control" name="aff_traffic_source[]" multiple multiselect-search="true">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                <label for="aff_business_card">Add Business Card</label>
...
<div class="modal fade" id="UpdateUsers" tabindex="-1" role="dialog" aria-labelledby="UpdateUserModalTitle" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content" id="updateusermodal">
                <div class="modal-header">
                    <h4 class="modal-title" id="UpdateUserModalTitle"><img src="https://crm.tremendio.network/assets/css/icons/new-icons/001-edit-user.png" style="width: 15%;">&nbsp;&nbsp;Update User</img></h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
                </div>            
                    <div class="modal-body">
                    <form  method="post" enctype="multipart/form-data" action="<?= base_url("crmaff/updatecrmaff"); ?>" id="updatecrmaff">
                    <input type="hidden" class="form-control" id="fk_user_id" name="fk_user_id">
                    <input type="hidden" class="form-control" id="crmaff_id" name="crmaff_id">
                     <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="date_created">Date Created</label>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <label for="aff_website">Website</label>
                                    <input id="u_aff_website" class="form-control" type="text"  name="u_aff_website" value="" required/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="aff_first_name">First Name</label>
                                    <input id="u_aff_first_name" class="form-control" type="text"  name="u_aff_first_name" value="" required/>
                                </div>
                                <div class="col-md-6">
                                    <label for="aff_last_name">Last Name</label>
                                    <input id="u_aff_last_name" class="form-control" type="text"  name="u_aff_last_name" value="" required/>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="aff_email">Email Address</label>
                                    <input id="u_aff_email" class="form-control" type="text"  name="u_aff_email" value="" required />
                                </div>
                                <div class="col-md-6">
                                    <label for="aff_skype">Skype/Telegram</label>
                                    <input id="u_aff_skype" class="form-control" type="text"  name="u_aff_skype" value="" required/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="aff_country">Country</label>
                                    <select id="u_aff_country" name="u_aff_country" class="form-control">
                                        <option selected hidden>-Please select-</option>
                                        <option value="Afghanistan">Afghanistan</option>
                                        <option value="Åland Islands">Åland Islands</option>
                                        <option value="Albania">Albania</option>
                                ...
                                <div class="col-md-6">
                                    <label for="aff_am">AM</label>
                                    <select id="u_aff_am" name="u_aff_am" class="form-control">
                                        <option selected hidden>-Please select-</option>
                                        <option value="JP">JP</option>
                                        <option value="Matt">Matt</option>
                                        <option value="Denis">Denis</option>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div id="tags1">
                                    <input type="hidden" class="hidden" id="u_aff_tags[]" name="u_aff_tags[]" value="">
                                    <textarea class="form-control" onclick="tags()" class="button"  id="u_aff_tags[]" rows="4" cols="50"></textarea>
                                ...
                                <div class="col-md-6">
                                    <label for="aff_model">Model</label> 
                                    <div id="model1">
                                    <input type="hidden" class="hidden1" id="u_aff_model[]" name="u_aff_model[]" value="">
                                    <textarea class="form-control" onclick="model()" class="button" id="u_aff_model[]" rows="4" cols="50"></textarea>
                        ...
                        <div class="form-group">
                             ...
                             <div class="col-md-6">
                                    <label for="aff_geo">Geo</label> 
                                    <div id="geo1">
                                    <input type="hidden" class="hidden2" id="u_aff_geo[]" name="u_aff_geo[]" value="">
                                    <textarea class="form-control" onclick="geo()" class="button" id="u_aff_geo[]" rows="4" cols="50"></textarea>
                                    ...
                                    <select name="u_aff_geo[]" multiple multiselect-search="true">
                                    <option>&nbsp;EUROPE</option>
                                    <option>&nbsp;LATAM</option>
                                    <option>&nbsp;MENA</option>
                                    <option>&nbsp;NORDICS</option>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="hidden" class="hidden3" id="u_aff_traffic_source[]" name="u_aff_traffic_source[]" value="">
                                    <textarea class="form-control" onclick="traffic_source()" class="button" id="u_aff_traffic_source[]" rows="4" cols="50"></textarea>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-12">
                                    <label for="aff_business_card">Business Card</label>
                                    <div class="business-card">
                                        <img src="" id="u_aff_business_card" name="u_aff_business_card">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-12">
                                    <label for="aff_comment">Comment</label>
                                    <textarea id="u_aff_comment" class="form-control" name="u_aff_comment" value="" rows="4" cols="50"></textarea>
                                </div>
                            </div>
                        </div>
                </div>
...
<div class="modal fade" id="ViewUsers" tabindex="-1" role="dialog" aria-labelledby="ViewUserModalTitle" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content" id="viewusermodal">
                <div class="modal-header">
                    <h4 class="modal-title" id="ViewUserModalTitle"><img src="https://crm.tremendio.network/assets/css/icons/new-icons/002-view-user.png" style="width: 18%;">&nbsp;&nbsp;View User</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
                </div> 
                    ...
                    <div class="modal-body">
                    <form method="post" enctype="multipart/form-data" id="viewcrmaff">
                    <input type="hidden" class="form-control" id="fk_user_id" name="fk_user_id">
                    <input type="hidden" class="form-control" id="crmaff_id" name="crmaff_id">
                     <div class="form-group">
                            <div class="row">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="aff_company">Company</label>
                                    <input id="v_aff_company" class="form-control" type="text"  name="v_aff_company" value="" disabled/>
                                </div>
                                <div class="col-md-6">
                                    <label for="aff_website">Website</label>
                                    <input id="v_aff_website" class="form-control" type="text"  name="v_aff_website" value="" disabled/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="aff_first_name">First Name</label>
                                    <input id="v_aff_first_name" class="form-control" type="text"  name="v_aff_first_name" value="" disabled/>
                                </div>
                                <div class="col-md-6">
                                    <label for="aff_last_name">Last Name</label>
                                    <input id="v_aff_last_name" class="form-control" type="text"  name="v_aff_last_name" value="" disabled/>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="aff_email">Email Address</label>
                                    <input id="v_aff_email" class="form-control" type="text"  name="v_aff_email" value="" disabled />
                                </div>
                                <div class="col-md-6">
                                    <label for="aff_skype">Skype/Telegram</label>
                                    <input id="v_aff_skype" class="form-control" type="text"  name="v_aff_skype" value="" disabled/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="aff_country">Country</label>
                                    <input id="v_aff_country" name="v_aff_country" class="form-control" type="text"   value="" disabled/>
                                </div>
                                <div class="col-md-6">
                                    <label for="aff_am">AM</label>
                                    <input id="v_aff_am" class="form-control" type="text"  name="v_aff_am" value="" disabled/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="aff_tags">Tags</label> 
                                    <textarea id="v_aff_tags[]" class="form-control" name="v_aff_tags[]" value="" rows="4" cols="50" disabled></textarea>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea id="v_aff_model[]" class="form-control" name="v_aff_model[]" value="" rows="4" cols="50" disabled></textarea>
                                </div>
                        </div>
                        <br>
                        <div class="form-group">
                             ...
                             <div class="col-md-6">
                                    <label for="aff_geo">Geo</label> 
                                    <textarea id="v_aff_geo[]" class="form-control" name="v_aff_geo[]" value="" rows="4" cols="50" disabled></textarea>
                                    <!--<input id="geo[]" class="form-control" type="text"  name="geo[]" value="" disabled/> -->
                                </div>
                                <div class="col-md-6">
                                    <label for="aff_traffic_source">Traffic Source</label> 
                                    <textarea id="v_aff_traffic_source[]" class="form-control" name="v_aff_traffic_source[]" value="" rows="4" cols="50" disabled></textarea>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-12">
                                    <label for="aff_business_card">Business Card</label>
                                    <div class="business-card">
                                        <img src="" id="v_aff_business_card" name="v_aff_business_card" style="width:100%;cursor:pointer" onclick="onClick(this)">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-12">
                                    <label for="aff_comment">Comment</label>
                                    <textarea id="v_aff_comment" class="form-control" name="v_aff_comment" value="" rows="4" cols="50" disabled></textarea>
                                </div>
                            </div>
                        </div>
                </div>
