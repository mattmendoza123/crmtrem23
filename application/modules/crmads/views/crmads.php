                ...
                <div class="modal-header">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                <label for="ads_business_card">Add Business Card</label>
                     ...
                     <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="ads_company">Company</label>
                                    <input id="u_ads_company" class="form-control" type="text"  name="u_ads_company" value="" required/>
                                </div>
                                <div class="col-md-6">
                                    <label for="ads_website">Website</label>
                                    <input id="u_ads_website" class="form-control" type="text"  name="u_ads_website" value="" required/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="ads_first_name">First Name</label>
                                    <input id="u_ads_first_name" class="form-control" type="text"  name="u_ads_first_name" value="" required/>
                                </div>
                                <div class="col-md-6">
                                    <label for="ads_last_name">Last Name</label>
                                    <input id="u_ads_last_name" class="form-control" type="text"  name="u_ads_last_name" value="" required/>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="ads_email">Email Address</label>
                                    <input id="u_ads_email" class="form-control" type="text"  name="u_ads_email" value="" required />
                                </div>
                                <div class="col-md-6">
                                    <label for="ads_skype">Skype/Telegram</label>
                                    <input id="u_ads_skype" class="form-control" type="text"  name="u_ads_skype" value="" required/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="ads_country">Country</label>
                                    <select id="u_ads_country" name="u_ads_country" class="form-control">
                                        <option selected hidden>-Please select-</option>
                                        <option value="Afghanistan">Afghanistan</option>
                                        <option value="Åland Islands">Åland Islands</option>
                                        <option value="Albania">Albania</option>
                                ...
                                <div class="col-md-6">
                                    <label for="ads_am">AM</label>
                                    <select id="u_ads_am" name="u_ads_am" class="form-control">
                                        <option selected hidden>-Please select-</option>
                                        <option value="JP">JP</option>
                                        <option value="Matt">Matt</option>
                                        <option value="Kirill">Kirill</option>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div id="tags1">
                                    <input type="hidden" class="hidden" id="u_ads_tags[]" name="u_ads_tags[]" value="">
                                    <textarea class="form-control" onclick="tags()" class="button"  id="u_ads_tags[]" rows="4" cols="50"></textarea>
                                    ...
                                    <select  name="u_ads_tags[]" multiple multiselect-search="true">
                                    <option>&nbsp;Dating</option>
                                    <option>&nbsp;Sweeps</option>
                                    <option>&nbsp;Nutra</option>
                                    <option>&nbsp;Finance</option>
                                ...
                                <div class="col-md-6">
                                    <label for="ads_model">Model</label> 
                                    <div id="model1">
                                    <input type="hidden" class="hidden1" id="u_ads_model[]" name="u_ads_model[]" value="">
                                    <textarea class="form-control" onclick="model()" class="button" id="u_ads_model[]" rows="4" cols="50"></textarea>
                                    ...
                                    <select name="u_ads_model[]" multiple multiselect-search="true">
                                    <option>&nbsp;CPC</option>
                                    <option>&nbsp;CPM</option>
                                    <option>&nbsp;CPA</option>
                                    <option>&nbsp;CPL</option>
                        ...
                        <div class="form-group">
                             ...
                             <div class="col-md-6">
                                    <label for="ads_geo">Geo</label> 
                                    <div id="geo1">
                                    <input type="hidden" class="hidden2" id="u_ads_geo[]" name="u_ads_geo[]" value="">
                                    <textarea class="form-control" onclick="geo()" class="button" id="u_ads_geo[]" rows="4" cols="50"></textarea>
                                    ...
                                    <select name="u_ads_geo[]" multiple multiselect-search="true">
                                    <option>&nbsp;EUROPE</option>
                                    <option>&nbsp;LATAM</option>
                                    <option>&nbsp;MENA</option>
                                    <option>&nbsp;NORDICS</option>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="u_ads_traffic_source[]" multiple multiselect-search="true">
                                    <option>&nbsp;Facebook</option>
                                    <option>&nbsp;Banner</option>
                                    <option>&nbsp;Email</option>
                                    <option>&nbsp;Native</option>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-12">
                                    <label for="ads_business_card">Business Card</label>
                                    <div class="business-card">
                                        <img src="" id="u_ads_business_card" name="u_ads_business_card">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group col-md-12">
                                    <div class="input-group up-business-card">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" id="u_ads_business_card" name="u_ads_business_card" aria-describedby="book-btn">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-12">
                                    <label for="ads_comment">Comment</label>
                                    <textarea id="u_ads_comment" class="form-control" name="u_ads_comment" value="" rows="4" cols="50"></textarea>
                                </div>
                            </div>
                        </div>
                </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="modal-body">
                    <form method="post" enctype="multipart/form-data" id="viewcrmads">
                    <input type="hidden" class="form-control" id="fk_user_id" name="fk_user_id">
                    <input type="hidden" class="form-control" id="crmads_id" name="crmads_id">
                     <div class="form-group">
                            <div class="row">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="ads_company">Company</label>
                                    <input id="v_ads_company" class="form-control" type="text"  name="v_ads_company" value="" disabled/>
                                </div>
                                <div class="col-md-6">
                                    <label for="ads_website">Website</label>
                                    <input id="v_ads_website" class="form-control" type="text"  name="v_ads_website" value="" disabled/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="ads_first_name">First Name</label>
                                    <input id="v_ads_first_name" class="form-control" type="text"  name="v_ads_first_name" value="" disabled/>
                                </div>
                                <div class="col-md-6">
                                    <label for="ads_last_name">Last Name</label>
                                    <input id="v_ads_last_name" class="form-control" type="text"  name="v_ads_last_name" value="" disabled/>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="ads_email">Email Address</label>
                                    <input id="v_ads_email" class="form-control" type="text"  name="v_ads_email" value="" disabled />
                                </div>
                                <div class="col-md-6">
                                    <label for="ads_skype">Skype/Telegram</label>
                                    <input id="v_ads_skype" class="form-control" type="text"  name="v_ads_skype" value="" disabled/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="ads_country">Country</label>
                                    <input id="v_ads_country" name="v_ads_country" class="form-control" type="text"   value="" disabled/>
                                </div>
                                <div class="col-md-6">
                                    <label for="ads_am">AM</label>
                                    <input id="v_ads_am" class="form-control" type="text"  name="v_ads_am" value="" disabled/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="ads_tags">Tags</label> 
                                    <textarea id="v_ads_tags[]" class="form-control" name="v_ads_tags[]" value="" rows="4" cols="50" disabled></textarea>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea id="v_ads_model[]" class="form-control" name="v_ads_model[]" value="" rows="4" cols="50" disabled></textarea>
                                </div>
                        </div>
                        <br>
                        <div class="form-group">
                             ...
                             <div class="col-md-6">
                                    <label for="ads_geo">Geo</label> 
                                    <textarea id="v_ads_geo[]" class="form-control" name="v_ads_geo[]" value="" rows="4" cols="50" disabled></textarea>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-12">
                                    <label for="ads_business_card">Business Card</label>
                                    <div class="business-card">
                                        <img src="" id="v_ads_business_card" name="v_ads_business_card" style="width:100%;cursor:pointer" onclick="onClick(this)">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="business-card">
                                        <a id="down_ads_business_card" class="btn btn-primary step-btn center_modalbutton"  href="" target="_blank" download>Download Business Card</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-12">
                                    <label for="ads_comment">Comment</label>
                                    <textarea id="v_ads_comment" class="form-control" name="v_ads_comment" value="" rows="4" cols="50" disabled></textarea>
                                </div>
                            </div>
                        </div>
                </div>
