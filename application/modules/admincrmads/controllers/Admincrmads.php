...
class Admincrmads extends MY_Controller
{
	...
	public function get_crmadslist()
	{
		...
		foreach ($crmads->result() as $tm) {
			...
			$action_btn .= "<a class='btn btn-xs delete-crmads' data-toggle='tooltip' data-placement='bottom' title='Remove IP'  href=".base_url('admincrmads/delete_crm/'.$tm->crmads_id)."><i class='fa fa-trash'></i></a>";
